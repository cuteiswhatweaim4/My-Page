const content = {
    technology: `
        <div class="content-section tech">
            <h2>Technology</h2>
    ...
    `,
    science: `
        <div class="content-section science">
            <h2>Science</h2>
    ...
    `,
    arts: `
        <div class="content-section arts">
            <h2>Arts</h2>
...
function showContent(topic) {
    ...
    // Apply unique styling for each topic
    document.getElementById("topic-content").className = `topic-content ${topic}`;
}

function returnHome() {
    document.getElementById("topic-content").classList.add("hidden");
    document.querySelector(".categories").style.display = "flex";
    document.getElementById("topic-content").className = "topic-content"; // Reset class
}
